...
Do not use any library such as “pandas-profiling” that automate the EDA process for you. We want you to be familiar with going through EDA steps on your own.
Do refer to the data description file (url found in project2 README.md).
Do not use advanced models such as neural networks, xgboost, etc
Do not submit your predictions to kaggle at the last minute as there may be a limit on the number of submissions per day.
Limit the number of features in your final model to between 25 to 30 features.
